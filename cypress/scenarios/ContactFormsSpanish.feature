Feature: Gage Mathers - Validate all contact forms - Spanish locale
  ...
  Scenario: Go to the Gage Mathers website
    ...
    Then user selects the locale 'Spanish'
    And verify user is in the Gage Mathers homepage 'Spanish'


  Scenario Outline: Sidebar - contact form
    Given verify user is in the Gage Mathers homepage 'Spanish'
    When user clicks the email button in the side bar
    ...
    Then verify sent message 'Gracias por su mensaje. Ha sido enviado.' is displayed in the pop up contact form
    And user clicks the close button in the pop up contact form

    Examples:
      | page | button | name         | email               | phone       | message                                   |
      | home | email  | QA Chornenky | jhomarq13@gmail.com | 12312312312 | QA Chornenky automation in Spanish locale |
  ...
  Scenario Outline: Homepage I've been injured WHAT SHOULD I DO? - contact form
    ...
    Then verify sent message 'Gracias por su mensaje. Ha sido enviado.' is displayed in homepage injured section contact form

    Examples:
      | name         | email               | phone       | message                                   |
      | QA Chornenky | jhomarq13@gmail.com | 12312312312 | QA Chornenky automation in Spanish locale |
  ...
  Scenario Outline: Homepage How Can We Help? - contact form
    ...
    Then verify sent message 'Gracias por su mensaje. Ha sido enviado.' is displayed in homepage help section contact form
  ...
  Scenario Outline: News article's detail page footer - contact form
    Given user navigates to the page 'Noticias'
    And verify user is taken to the 'Noticias' page
    ...
    Then verify sent message 'Gracias por su mensaje. Ha sido enviado.' is displayed in the footer contact form
  ...
  Scenario Outline: Contact page - contact form
    Given user navigates to the page 'Contáctenos'
    And verify user is taken to the 'Contáctenos' page
    ...
    Then verify sent message 'Gracias por su mensaje. Ha sido enviado.' is displayed in contact page contact form

    Examples:
      | name         | email               | phone       | zip   | state     | message                                   |
      | QA Chornenky | jhomarq13@gmail.com | 12312312312 | 12312 | UT - Utah | QA Chornenky automation in Spanish locale |
